...
#if defined(htobe16) && defined(htole16) && defined(be16toh) && defined(le16toh) && defined(htobe32) &&                \
    defined(htole32) && defined(be32toh) && defined(htole32) && defined(htobe64) && defined(htole64) &&                \
    defined(htobe64) && defined(be64toh) && defined(htole64) && defined(le64toh)
...
#define htobe32(x) (x)
#define htole32(x)                                                                                                     \
    (((uint32_t)htole16(((uint16_t)(((uint32_t)(x)) >> 16)))) | (((uint32_t)htole16(((uint16_t)(x)))) << 16))
#define be32toh(x) (x)
#define le32toh(x)                                                                                                     \
    (((uint32_t)le16toh(((uint16_t)(((uint32_t)(x)) >> 16)))) | (((uint32_t)le16toh(((uint16_t)(x)))) << 16))

#define htobe64(x) (x)
#define htole64(x)                                                                                                     \
    (((uint64_t)htole32(((uint32_t)(((uint64_t)(x)) >> 32)))) | (((uint64_t)htole32(((uint32_t)(x)))) << 32))
#define be64toh(x) (x)
#define le64toh(x)                                                                                                     \
    (((uint64_t)le32toh(((uint32_t)(((uint64_t)(x)) >> 32)))) | (((uint64_t)le32toh(((uint32_t)(x)))) << 32))
#else
